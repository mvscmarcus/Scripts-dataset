...
df_final.to_csv("csv_issues/issues_media_popularidade.csv", index=False, encoding="utf-8")
print("Coleta finalizada! Arquivo salvo como issues_media_popularidade.csv")
