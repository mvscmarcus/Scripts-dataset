...
df_final.to_csv("csv_issues/issues_baixa_popularidade.csv", index=False, encoding="utf-8")
print("Coleta finalizada! Arquivo salvo como issues_baixa_popularidade.csv")
